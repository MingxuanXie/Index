---
layout: post
title: "NFT+WebVR可以实现线上展览的终极形态吗？我的一些尝试"
categories: blog
---  

金融泡沫已经抛弃了腐朽的物理房地产，转而在NFT包装下的虚拟房地产上高歌猛进<sup>[[1]](#footnote1)</sup>
...
虽然使用IPFS这样带哈希验证的去中心储存服务，绝大多数情况下可以避免这种挂羊头卖狗肉的行为，
但赛博空间同样没有免费的午餐——长期储存这个文件
该由谁来负责供养费呢？
...
OpenSea基于ERC-1155的lazymint功能实现了除去初始化账户时需要支付的gas费用，可无其他费用无限上
...
帕大炮已经对Decentraland表现出巨大兴趣（线上讨论），
但其使用闭源的Unity进行的开发同样让人担忧——

然而使用开源WebVR框架babylon.js开发的Cryptovoxels，所谓的区块链版本的*我的世界*，也同样生机勃勃的召开着各种“NFT线上展览”——虽然这些展览大多是在直白的忽悠人去买买买。
...
泡沫破灭后的肥皂会沉淀下来成为去中心元宇宙基建的一部分。即便绝大多数NFT会在未来（已经？）被贬得一文不值，但因为这一波狂热，加速了加密钱包账户的破圈应用，不少非币圈用户也安装了加密钱包工具，而这是去中心化网络及应用普及的第一步。
...
<a name="footnote1"></a>[1] that’s still soap, and that’s not nothing.
